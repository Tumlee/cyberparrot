kernel void multiply_2o( global float* heap,
                    constant uint* vOff,
                    constant uint* o1Off,
                    constant uint* o2Off,
...
kernel void multiply_3o( global float* heap,
                    constant uint* vOff,
                    constant uint* o1Off,
                    constant uint* o2Off,
                    constant uint* o3Off,
...
kernel void multiply_4o( global float* heap,
                    constant uint* vOff,
                    constant uint* o1Off,
                    constant uint* o2Off,
                    constant uint* o3Off,
...
kernel void multiply_5o( global float* heap,
                    constant uint* vOff,
                    constant uint* o1Off,
                    constant uint* o2Off,
                    constant uint* o3Off,
